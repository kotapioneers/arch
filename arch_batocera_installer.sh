...
pacman -S --noconfirm emulationstation retroarch dolphin-emu ppsspp steam lutris xorg-xrandr xorg-xinput xboxdrv antimicrox python-pip

# Install AUR packages
sudo -u $USERNAME yay -S --noconfirm pcsx2-git portmaster
...
# ---------------- Controller Setup (Right Stick Mouse + Triggers) ----------------
...
[Service]
ExecStart=/usr/bin/xboxdrv --detach-kernel-driver --daemon \
--mimic-xpad \
--axismap="REL_X=RX*2,REL_Y=RY*2" --mouse \
--trigger-as-button \
...
sudo -u $USERNAME git clone https://github.com/RetroGameSets/RGSX.git /home/$USERNAME/rgsx
