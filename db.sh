#!/bin/bash
# Debian 12/13 All-in-One Gamer Setup (Console Style)
...
apt install -y sudo git curl wget unzip \
    xorg xserver-xorg-video-intel xserver-xorg-video-all \
    mesa-utils mesa-vulkan-drivers libgl1-mesa-dri \
    pulseaudio alsa-utils dbus-x11 \
    xfce4 xfce4-goodies \
    emulationstation retroarch libretro-* pcsx2 dolphin-emu ppsspp flycast \
...
apt -y purge libreoffice* thunderbird* hexchat* transmission* rhythmbox* gnome-games gnome-sudoku gnome-mahjongg gnome-mines
...
# --- Done ---
echo "===================================================="
echo "==> Debian Gamer Console Setup Complete!"
